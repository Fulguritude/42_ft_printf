...
int main()
{
	...
	//ft_printf("ft_printf %#-+05.5d and %#-+06.5d\n", 123456, 123);

	printf(C_GREEN"\n\nTest %d:\n"RESET, ++i);
	return_values[j++] =    printf("   printf %-+5.5d and %-+6.5d\n", 123456, 123);
	return_values[j++] = ft_printf("ft_printf %-+5.5d and %-+6.5d\n", 123456, 123);
	printf(C_GREEN"\n\nTest %d:\n"RESET, ++i);
	return_values[j++] =    printf("   printf %-+5.5d and %-+5.5d\n", 123456, 123);
	return_values[j++] = ft_printf("ft_printf %-+5.5d and %-+5.5d\n", 123456, 123);
	printf(C_GREEN"\n\nTest %d:\n"RESET, ++i);
	return_values[j++] =    printf("   printf %-+5.5d and %-+4.5d\n", 123456, 123);
	return_values[j++] = ft_printf("ft_printf %-+5.5d and %-+4.5d\n", 123456, 123);
	printf(C_GREEN"\n\nTest %d:\n"RESET, ++i);
	return_values[j++] =    printf("   printf %-+5.5d and %-+3.5d\n", 123456, 123);
	return_values[j++] = ft_printf("ft_printf %-+5.5d and %-+3.5d\n", 123456, 123);
...
//	return_values[j++] =    printf("   printf: %s gives %0.2u\n", "%0.2u", 123);
	...
	while (i < j)
	{
		printf("Test %3d: printf %d ; ft_printf %d\n", i / 2, return_values[i], return_values[i + 1]);
		i += 2;
	}
